        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                ...
                <div class="recommended_items"><!--recommended_items-->
                    ...
                    <a class="left recommended-item-control" id="next" href="#recommended-item-carousel" data-slide="next">
                        <i class="fa fa-angle-left"></i>
                    </a>
                    <a class="right recommended-item-control" id="prev"  href="#recommended-item-carousel" data-slide="prev">
