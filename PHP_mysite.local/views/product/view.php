					...
					<div class="row">
						...
						<div class="col-sm-7">
							<div class="product-information">
								...
								<span> <span><?php echo $product['price']; ?> грн.</span> 
								<label ">Количество:</label> 
								<input type="text" value="1" id="amount" />
									 
									<button  type="button" class="btn btn-fefault add-amount-cart" data-id="<?php echo $product['id']; ?>">
								...
								<p>
									<b>Производитель:</b> <?php echo $product['brand']; ?>
								</p>
							</div>
							<!--/product-information-->
						</div>
