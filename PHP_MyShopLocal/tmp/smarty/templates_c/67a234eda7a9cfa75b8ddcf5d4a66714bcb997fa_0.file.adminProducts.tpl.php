<?php
/* Smarty version 3.1.30, created on 2016-11-08 08:51:11
  from "C:\xampp\htdocs\myshop.local\views\admin\adminProducts.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_582183efa17973_01293179',
...
function content_582183efa17973_01293179 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
<table border="1" cellpadding="1" cellspacing="1">
	...
	<tr>
		...
		<td><select id="newItemCatId">
				<option value="0">Главная категория <?php
...
" type="edit" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['price'];?>
" />
			</td>
			<td>
				<!-- <select id="ItemCategory_<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
">
					<option value=""><?php echo $_smarty_tpl->tpl_vars['item']->value['category_name'];?>

					<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['rsCategories']->value, 'itemCategory');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['itemCategory']->value) {
?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['itemCategory']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['itemCategory']->value['name'];?>
...
?>
						<option value="<?php echo $_smarty_tpl->tpl_vars['itemCategory']->value['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['item']->value['category_id'] == $_smarty_tpl->tpl_vars['itemCategory']->value['id']) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['itemCategory']->value['name'];?>
