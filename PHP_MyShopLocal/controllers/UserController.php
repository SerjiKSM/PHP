 ...
 * initialization session variable ($_SESSION['user'])
 * 
 ...
 * 
 * @link /user/
 * @param object $smarty  pattern
 */
function indexAction($smarty){
	
	// if user hasn`t autorization, then redirect him to main page
	if(! isset($_SESSION['user'])){
		redirect('/');
	}
	
	// get list categoris for menu
...
function updateAction(){
	...
	// if user has not registration then exit
	if(! isset($_SESSION['user'])){
		redirect('/');
	}
