			...
			<tr>
				...
				<td>
					<span id="itemCnt_{$item['id']}">
						<input name="itemCnt_{$item['id']}"	type="hidden" value="{$item['cnt']}" />
						{$item['cnt']}
					</span>				
				</td>
				<td>
					<span id="itemPrice_{$item['id']}">
						<input name="itemPrice_{$item['id']}"	type="hidden" value="{$item['price']}" />
						{$item['price']}
					</span>				
				</td>
				<td>
					<span id="itemRealPrice_{$item['id']}">
						<input name="itemRealPrice_{$item['id']}"	type="hidden" value="{$item['realPrice']}" />
						{$item['realPrice']}
					</span>				
				</td>
			</tr>
