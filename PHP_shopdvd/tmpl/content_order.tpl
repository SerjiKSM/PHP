        ...
        <table>
            ...
            <tr>
                <td class="button">
                    ...
                    <!--<form name="end_order" action="#" method="post" >
                        <p><input type="submit" value="Закончить оформление заказа" ></p>
                    </form> -->

                        <input type="image" src="/images/buttonorder.png" alt="Закончить оформление заказа" onmousemove="this.src='/images/buttonorderclick.png'" onmouseout="this.src='/images/buttonorder.png'" />
